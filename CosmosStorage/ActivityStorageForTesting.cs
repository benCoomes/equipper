...
namespace Coomes.Equipper.CosmosStorage
{
    ///
    /// <summary>
    /// An subclass of ActivityStorage intended for testing. 
    ...
    /// </summary>
    ///
    public class ActivityStorageForTesting : ActivityStorage
    {
        public ActivityStorageForTesting(string connectionString, string database, string container) : base(connectionString)
        {
            DatabaseID = database;
